            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="Button4" runat="server" CssClass="btn btn-primary" OnClick="Button4_Click" Text="Send Code" />
                ...
                <div class="card card-feature text-center text-lg-left">
                    <div class="login100-form validate-form p-b-33 p-t-5">
                        ...
                        <div class="form-item form-btn-wrp pl-4">
                            ...
                            <asp:LinkButton ID="LinkButton1" runat="server"  CssClass="btn btn-link"  data-toggle="modal" data-target="#exampleModal">Forgot Password</asp:LinkButton>
